...
const CATEGORY_BY_TITLE = {
  "Cozy Beachfront Cottage": "Beachfront",
  "Modern Loft in Downtown": "Iconic Cities",
  "Mountain Retreat": "Mountains",
  "Historic Villa in Tuscany": "Rooms",
  "Secluded Treehouse Getaway": "Farms",
  "Beachfront Paradise": "Beachfront",
  ...
  "Beachfront Villa in Greece": "Beachfront",
  "Eco-Friendly Treehouse Retreat": "Farms",
  ...
  "Secluded Beach House in Costa Rica": "Beachfront",
};
...
const data = sampleListings.map((listing, index) => ({
  ...listing,
  category: CATEGORY_BY_TITLE[listing.title] || "Rooms",
  isTrending: index < 6,
  geometry: {
    type: "Point",
    coordinates: LOCATION_COORDINATES[listing.location] || [-118.2437, 34.0522],
  },
}));
